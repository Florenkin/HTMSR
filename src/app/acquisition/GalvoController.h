...
public:
    ...
    virtual GalvoCommandResult sendRawCommand(const std::vector<unsigned char>& command, bool expectResponse = false) = 0;
};
...
public:
    ...
    */
    ...
    GalvoCommandResult sendRawCommand(const std::vector<unsigned char>& command, bool expectResponse = false) override;
