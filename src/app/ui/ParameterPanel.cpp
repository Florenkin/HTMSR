    ...
    : QWidget(parent)
{
    ...
    leftRoiXSpin_ = createSpinRow(QString(), 0, 100000, 0);
    leftRoiYSpin_ = createSpinRow(QString(), 0, 100000, 0);
    leftRoiWSpin_ = createSpinRow(QString(), 1, 100000, 3072);
    leftRoiHSpin_ = createSpinRow(QString(), 1, 100000, 2048);
    rightRoiXSpin_ = createSpinRow(QString(), 0, 100000, 0);
    rightRoiYSpin_ = createSpinRow(QString(), 0, 100000, 0);
    rightRoiWSpin_ = createSpinRow(QString(), 1, 100000, 3072);
    rightRoiHSpin_ = createSpinRow(QString(), 1, 100000, 2048);
    grayThresholdSpin_ = createSpinRow(QString(), 0, 255, 150);
    minGraySpin_ = createSpinRow(QString(), 0, 255, 30);
    ...
    matchDistanceSpin_ = createDoubleSpinRow(QString(), 0.0001, 100.0, 0.1);
